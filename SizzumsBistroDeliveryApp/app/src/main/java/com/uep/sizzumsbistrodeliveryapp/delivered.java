...
public class delivered extends AppCompatActivity {
    ...
    AppCompatButton pending,showall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pending = findViewById(R.id.appCompatButton);


        loading = new Dialog(delivered.this);
        loading.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        loading.setCancelable(false);
        loading.setContentView(R.layout.dialog_loading);

        btnlogout = findViewById(R.id.logout);
        logout = new Dialog(delivered.this);
            ...
            public void onClick(View view) {
                ...
                ParseUser.logOutInBackground(new LogOutCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e == null) {
                            Intent intent = new Intent(delivered.this,signin.class);
                            startActivity(intent);
                            finish();
                            Toast.makeText(delivered.this, "Logged out successfully!", Toast.LENGTH_SHORT).show();
                        } else {
                            loading.dismiss();
                            Toast.makeText(delivered.this, "Error " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
        ...
        pending.setOnClickListener(v -> {
            Intent intent = new Intent(delivered.this, dashboard.class);
            startActivity(intent);
            finish();
        });
        ...
        confirmed.whereEqualTo("status","delivered");
